...
const ProblemForm = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md text-center justify-center">
      ...
      {/* Nombre del problema */}
      <div className="flex-col gap-6 justify-center sm:flex sm:flex-row">
        <div className="mb-4">
          <div className="mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              <label className="block text-gray-700 mb-2">Número de Demandas</label>
              <select
              ...
              >
                {[2, 3, 4, 5, 6].map(num => (
                  <option key={num} value={num}>{num} demandas</option>
                ))}
              </select>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              {formData.demand.map((value, index) => (
                <div key={index} className="flex items-center mb-2">
                  <span className="w-20 text-gray-600">Demanda {index + 1}:</span>
                  <input
                    type="number"
                    value={value}
